...
except ImportError:  # optional; install with: pip install yapf
    def FormatCode(text, style_config=None, **kwargs):
        return text, None
...
class SLConfig(object):
    ...
    def pretty_text(self):
        ...
        # yapf>=0.40 removed the `verify` kwarg from FormatCode
